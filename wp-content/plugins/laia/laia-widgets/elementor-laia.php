<?php
/**
 * Elementor_Laia class.
 */

final class Elementor_Laia {
	 ...
	 * @static
	 *
	 * @var Elementor_Laia The single instance of the class.
	 */
	 ...
	 * @static
	 *
	 * @return Elementor_Laia An instance of the class.
	 */
	...
	public function i18n() {
		...
		load_plugin_textdomain( 'elementor-fuga-family' );
	...
	public function init() {
		...
		add_action( 'elementor/elements/categories_registered', [ $this, 'init_widget_category' ] );
	}
	 ...
	 * Init Widgets
	 *
	 * Include category and register them
	 *
	 * @since 1.0.0
	 *
	 * @access public
	...
	public function init_widgets() {
		...
		require_once( __DIR__ . '/widgets/menu-section.php' );
