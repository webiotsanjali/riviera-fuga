 ...
 * Plugin URI:  https://github.com/wp-bootstrap/laia
 * Description: A custom WordPress nav walker class to implement the Bootstrap 4 navigation style in a custom theme using the WordPress built in menu manager.
 * Author: Edward McIntyre - @twittem, WP Bootstrap, William Patton - @pattonwebz
 * Version: 4.3.0
 * Author URI: https://github.com/wp-bootstrap
 * GitHub Plugin URI: https://github.com/wp-bootstrap/laia
...
if (!class_exists('WP_Bootstrap_Navwalker')):
    ...
    class WP_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        {
            if (!has_filter('wp_nav_menu_args', array(
                $this,
        ...
        public static function fallback($args)
        {
            ...
            $fallback_output .= '<li class="nav-item"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link" title="' . esc_attr__('Add a menu', 'laia') . '">' . esc_html__('Add a menu', 'laia') . '</a></li>';
            $fallback_output .= '</ul>';
            ...
            if (array_key_exists('echo', $args) && $args['echo'])
            {
                ...
                echo wp_kses_post($fallback_output, 'laia');
            }
            else
            {
